 ...
 * @author Jerry Cai
 */
public class TutorialFragmentActivity extends android.support.v4.app.FragmentActivity implements TipTouchEventInterface, TutorialActivityInterface {
    ...
    public void setFragment(Fragment fragment) {
            mTipPresenter.setTargetFragment(fragment);
    }
